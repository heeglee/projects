...
<div id="sub">
  ...
  <section class="view">
    <nav>
      <h1>[블루포스] FreeMovement BLUEFORCE</h1>
      <p>
    ...
    <section>
      <article class="info">
        <div class="image">
          <img src="/kmarket/img/sample-view-item1.jpg" alt="상품이미지"/>
        </div>
        <div class="summary">
          <nav>
            <h1>(주)블루포스</h1>
          ...
          <p>남자 셔츠 남방 남성 와이셔츠 체크남방 스트라이프</p>
          <nav>
          ...
          <img src="/kmarket/img/vip_plcc_banner.png" alt="100원만 결제해도 1만원 적립!" class="banner" />
          <div class="option">
            <strong>선택옵션</strong>
            <div class="opt_model">
              <button>
                <span class="txt">모델</span>
      ...
      <article class="detail">
        ...
        <!-- 상품상세페이지 이미지 -->
        <img src="/kmarket/img/sample_detail1.jpg" alt="">
        <img src="/kmarket/img/sample_detail2.jpg" alt="">
